...
parameters
    esub_w(r)  	subsitution elasticity between savings and full consumption,
	esub_z(r)	substitution elasticity between leisure and consumption
...
parameters
	...
	esub_wh(r,h)	substitution elasticity between savings and full consumption
;
