...
scalar es_cd	substitution elasticity	/0.99/;


$macro CC(r)	(sum(gg$theta_cd(r,gg),theta_cd(r,gg)*PA(r,gg)**(1-es_cd))**(1/(1-es_cd)))
$macro CD(r,g)	((CC(r)/PA(r,g))**es_cd)	
